...
# distribution of values for each predictor variable across 12 land cover types 
...
# oil palm young (OPY); rubber mature (RBM); rubber young (RBY); rubber new (RBN);
# shrub/orchard (SHB); rice paddy (RPD); built-up area (BUA); bare soil/ground (BSG);
# and water (WTR).
#
...
sarHH_IDM <- sarHH_IDM + ylim(0,0.07)
...
ggsave(optB6, file="Boxplot-B5.png", width=19.89, height=15, units="cm", dpi=300)
...
ggsave(optB11, file="Boxplot-B11.png", width=19.89, height=15, units="cm", dpi=300)
