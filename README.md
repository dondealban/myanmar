...
3. Three tests were computed: with continuity correction, without continuity correction, and the exact 2x2 test. These were assessed at three critical values using alpha = 0.01, 0.05, and 0.10.  
