...
setwd("/Users/dondealban/Dropbox/Research/myanmar/3 mmr land cover transitions/mangroves/stacked area/2_bago")
...
ggsave(plot, file="StackedArea-02-Bago.pdf", width=16, height=15, units="cm", dpi=300)
