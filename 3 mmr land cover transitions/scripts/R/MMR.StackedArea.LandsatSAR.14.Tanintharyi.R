...
setwd("/Users/dondealban/Dropbox/Research/myanmar/3 mmr land cover transitions/mangroves/stacked area/5_tanintharyi")
...
ggsave(plot, file="StackedArea-05-Tanintharyi.pdf", width=16, height=15, units="cm", dpi=300)
