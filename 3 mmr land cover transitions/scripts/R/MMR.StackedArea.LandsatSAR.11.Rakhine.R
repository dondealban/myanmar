...
setwd("/Users/dondealban/Dropbox/Research/myanmar/3 mmr land cover transitions/stacked area/11_rakhine")
...
ggsave(plot, file="StackedArea-11-Rakhine.pdf", width=19.89, height=15, units="cm", dpi=300)
