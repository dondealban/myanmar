...
setwd("/Users/dondealban/Dropbox/Research/myanmar/3 mmr land cover transitions/mangroves/stacked area/6_yangon")
...
ggsave(plot, file="StackedArea-06-Yangon.pdf", width=16, height=15, units="cm", dpi=300)
