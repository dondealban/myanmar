...
setwd("/Users/dondealban/Dropbox/Research/myanmar/3 mmr land cover transitions/stacked area/1_ayeyarwady")
...
ggsave(plot, file="StackedArea-01-Ayeyarwady.pdf", width=19.89, height=15, units="cm", dpi=300)
